...
public class Guidebook5Screen extends AbstractContainerScreen<Guidebook5Menu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, "we hope it has proven", 16, 66, -12829636);
		this.font.draw(poseStack, "to be useful for you.", 16, 78, -12829636);
		...
		this.font.draw(poseStack, "Some Debug info:", 16, 98, -12829636);
		this.font.draw(poseStack, "[" + (EspcraftModVariables.MapVariables.get(world).Value) + "]", 16, 122, -65536);
		this.font.draw(poseStack, "Current value holder:", 16, 110, -12829636);
